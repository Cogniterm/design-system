...
},
{
  ...
  props: [['modelValue','string',`''`,'v-model.'],['placeholder','string',`'검색…'`,'안내.'],['shortcut','string','—','⌘K 힌트 — 포커스 전에만 표시.'],['loading','boolean','false','검색 중 스피너.']],
...
},
{
  ...
  props: [['modelValue','number','—','v-model.'],['min / max / step','number','— / — / 1','범위.'],['label / hint / error','string','—','필드 공통.']],
  slots: [],
...
},
{
  ...
  props: [['modelValue','string[]','[]','v-model — 칩 배열.'],['items','string[]','—','제안 목록.'],['label / hint / error','string','—','필드 공통.']],
  slots: [],
...
},
{
  ...
  props: [['location','string',`'bottom start'`,'열리는 방향.'],['width','number | string','280','패널 폭.']],
  ...
  html: null,
  guidelines: [['하지 말 것','확인이 필요한 입력은 Popover가 아니라 Dialog.']],
},
{
