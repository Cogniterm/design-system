...
},
{
  ...
  props: [
    ...
    ['size', `'sm' | 'default'`, `'default'`, '32 / 40px — 필터 바·툴바는 sm.'],
  ...
  demos: [
    ...
    { key: 'sizes',     title: 'Sizes',     desc: '32 / 40px — 다른 입력 컨트롤과 같은 두 단계.' },
  ...
  guidelines: [
    ...
    ['하지 말 것', '날짜를 손으로 치게 하지 않습니다. 형식 검증과 오타 안내가 통째로 따라옵니다.'],
  ],
},
{
...
},
{
  ...
  props: [['modelValue','string',`''`,'v-model.'],['placeholder','string',`'검색…'`,'안내.'],['shortcut','string','—','⌘K 힌트 — 포커스 전에만 표시.'],['loading','boolean','false','검색 중 스피너.'],['size',`'sm' | 'default'`,`'default'`,'컨트롤 스케일 32 / 40px. 필터 바·툴바는 sm.']],
...
},
{
  ...
  props: [['modelValue','number','—','v-model.'],['min / max / step','number','— / — / 1','범위.'],['label / hint / error','string','—','필드 공통.'],['size',`'sm' | 'default'`,`'default'`,'컨트롤 스케일 32 / 40px. 필터 바·툴바는 sm.']],
  slots: [],
...
},
{
  ...
  props: [['modelValue','string[]','[]','v-model — 칩 배열.'],['items','string[]','—','제안 목록.'],['label / hint / error','string','—','필드 공통.'],['size',`'sm' | 'default'`,`'default'`,'컨트롤 스케일 32 / 40px. 필터 바·툴바는 sm.']],
  slots: [],
