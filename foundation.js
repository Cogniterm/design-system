...
export function fdColor() {
  ...
  return `
    ...
    <div class="prose">
      ...
      <p>
        차트 계열과 <b>같은 토큰이지만 쓰는 법이 다릅니다.</b> 차트는 1부터 순서대로 채우고,
        여기서는 <b>'종류'에 색을 고정</b>합니다 — 순위나 개수가 바뀌어도 그 종류는 늘 같은 색입니다.
        문서 종류·노드 라벨처럼 화면을 오가며 대조하는 값이 대상입니다.
        <b>7 · 8은 고정용으로만</b> 늘렸습니다(차트 계열은 여전히 6까지).
      </p>
