...
export { default as DsCheckbox } from './components/vuetify/DsCheckbox.vue'
export { default as DsRadioGroup } from './components/vuetify/DsRadioGroup.vue'
...
export { default as DsTreeview } from './components/vuetify/DsTreeview.vue'
