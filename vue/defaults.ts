...
export const dsDefaults = {
  ...
  VSlider: { color: 'primary', trackColor: 'var(--muted)', density: 'comfortable', hideDetails: 'auto', elevation: 0, thumbSize: 16, trackSize: 6 },
  VRangeSlider: { color: 'primary', trackColor: 'var(--muted)', density: 'comfortable', hideDetails: 'auto', elevation: 0, thumbSize: 16, trackSize: 6 },
